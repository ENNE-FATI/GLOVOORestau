          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('assets/img/images/promo-1.png') }}" width="300" height="300" loading="lazy" alt="Maxican Pizza"
     class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('assets/img/images/promo-2.png') }}" width="300" height="300" loading="lazy" alt="Soft Drinks"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('assets/img/images/promo-3.png') }}" width="300" height="300" loading="lazy" alt="French Fry"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('assets/img/images/promo-4.png') }}" width="300" height="300" loading="lazy" alt="Burger Kingo"
                  class="w-100 card-banner">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <img src="{{ asset('assets/img/images/promo-5.png') }}" width="300" height="300" loading="lazy" alt="Chicken Masala"
                  class="w-100 card-banner">
      ...
      <section class="section section-divider gray about" id="about">
        <div class="container">
            ...
            <div class="about-banner">
                <img src="{{ asset('assets/img/images/about-banner.png') }}" width="509" height="459" loading="lazy" alt="Burger with Drinks"
                     class="w-100 about-img">
            
                <img src="{{ asset('assets/img/images/sale-shape-red.png') }}" width="216" height="226" alt="get up to 50% off now"
      ...
      <section class="section section-divider white cta" style="background-image: url('./assets/images/hero-bg.jpg')">
        <div class="container">
          ...
          <figure class="cta-banner">
            <img src="{{ asset('assets/img/images/cta-banner.png') }}" width="700" height="637" loading="lazy" alt="Burger"
                 class="w-100 cta-img">
        
            <img src="{{ asset('assets/img/images/sale-shape.png') }}" width="216" height="226" loading="lazy"
          ...
          <ul class="banner-list">
            ...
            <li class="banner-item banner-lg">
              <div class="banner-card">
                ...
                <img src="{{ asset('assets/img/images/banner-1.jpg') }}" width="550" height="450" loading="lazy"
                alt="Discount For Delicious Tasty Burgers!" class="banner-img">
                <div class="banner-item-content">
                  <p class="banner-subtitle">50% Off Now!</p>

                  <h3 class="banner-title">Discount For Delicious Tasty basta!</h3>
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="{{ asset('assets/img/images/banner-2.jpg') }}" width="550" height="465" loading="lazy" alt="Delicious Pizza"
                  class="banner-img">
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <img src="{{ asset('assets/img/images/banner-3.jpg') }}" width="550" height="465" loading="lazy" alt="American Burgers"
                  class="banner-img">
            ...
            <li class="banner-item banner-md">
              <div class="banner-card">
                ...
                <img src="{{ asset('assets/img/images/banner-4.jpg') }}" width="550" height="220" loading="lazy" alt="Tasty Buzzed Pizza"
                  class="banner-img">
      ...
      <section class="section section-divider gray delivery">
        <div class="container">
          ...
          <figure class="delivery-banner">
            <img src="{{ asset('assets/img/images/delivery-banner-bg.png') }}" width="700" height="602" loading="lazy" alt="clouds"
                 class="w-100">
        
            <img src="{{ asset('assets/img/images/delivery-boy.svg') }}" width="1000" height="880" loading="lazy" alt="delivery boy"
...
<li>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="{{ asset('assets/img/images/avatar-1.jpg') }}" width="80" height="80" loading="lazy" alt="Robert William">
                  </figure>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="{{ asset('assets/img/images/avatar-2.jpg') }}" width="80" height="80" loading="lazy" alt="Thomas Josef">
                  </figure>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <figure class="avatar">
                    <img src="{{ asset('assets/img/images/avatar-3.jpg') }}" width="80" height="80" loading="lazy" alt="Charles Richard">
                  </figure>
  ...
  <div class="contact-info"><iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3453.3751164263294!2d31.345662810798682!3d30.054780317976828!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583e7a1bb7605d%3A0xe8e44cb0e5604cb7!2sMostafa%20El-Nahaas%2C%20Nasr%20City%2C%20Cairo%20Governorate!5e0!3m2!1sen!2seg!4v1698784931632!5m2!1sen!2seg"
