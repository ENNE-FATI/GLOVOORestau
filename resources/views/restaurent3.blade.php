...
<body id="top" >
    <header class="header" data-header>
        <div class="container">
          ...
          <h1>
            <a href="#" class="logo">Bistro Soleil<span class="span">.</span></a>
          </h1>
      ...
      <section class="hero" id="home" style="background-image: url('{{ asset('assets/img/images/blog-3.jpg') }}')">
    <div class="container">
      ...
      <div class="hero-content">
        ...
        <h2 class="h1 hero-title">Bistro Soleil - A Taste of Paradise!</h2>
        
        <p class="hero-text">Indulge in an unforgettable culinary experience at Bistro Soleil, where every dish is crafted with passion and flavor.</p>
...
<!--
      <figure class="hero-banner">
        <img src="./assets/images/restaurant3.jpeg" width="820" height="716" alt="" aria-hidden="true"
          class="w-100 hero-img-bg">
          

        <img src="./assets/images/food-menu-2.png" width="700" height="637" loading="lazy" alt="Burger"
